<script>
	...
	const hlStyling =
		'block py-2 pl-3 pr-4 text-white class:bg-blue-700 rounded md:bg-transparent md:text-blue-700 md:p-0 dark:text-white';
</script>
		...
		>
			...
			>
				<li>
					<a
						href="/"
						class={$page.url.pathname === '/' ? hlStyling : notHlStyling}
